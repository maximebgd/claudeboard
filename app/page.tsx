...
export default async function HomePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-10">
      ...
      <p className="mt-1 text-sm text-neutral-500 font-mono">{CLAUDE_DIR}</p>
      ...
      <div className="mt-10">
        <h2 className="text-sm font-medium text-neutral-400 mb-3">Skills récents</h2>
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-panel)] divide-y divide-[var(--color-border)]">
          {skills.length === 0 && (
            <div className="p-4 text-sm text-neutral-500">Aucun skill trouvé.</div>
          )}
